...
import { groupAttendeesBySiteLocation, getSiteLocationOrderGroups } from "@/utils/siteLocationGroupUtils";
    ...
    <Card>
      ...
      <CardContent>
          ...
          <Table>
            ...
            <TableBody>
              {siteGroups.map((siteGroup) => {
                ...
                const orderGroups = getSiteLocationOrderGroups(siteGroup);
                    ...
                    >
                      ...
                      <TableCell>
                        <Badge variant="secondary">
                          {siteGroup.orders.size} order{siteGroup.orders.size !== 1 ? 's' : ''}
                        </Badge>
                      </TableCell>
                      <TableCell>
                        <div className="flex items-center gap-2">
                      ...
                      <TableRow>
                        <TableCell colSpan={5} className="p-0">
                          <div className="p-4 bg-muted/10 border-l-4 border-primary/20">
                            {/* Orders within this site */}
                            <div className="space-y-2">
                              {orderGroups.map((orderGroup) => {
                                const orderKey = `${siteGroup.siteKey}-${orderGroup.orderId}`;
        ...
        <div className="flex justify-between items-center text-sm text-muted-foreground">
          <div>
            Showing {siteGroups.length} site location{siteGroups.length !== 1 ? 's' : ''} 
