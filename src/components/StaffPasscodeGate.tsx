...
interface StaffPasscodeGateProps {
  /** Called after a successful unlock. If omitted, the parent re-renders on its own. */
  onUnlock?: () => void;
}

export function StaffPasscodeGate({ onUnlock }: StaffPasscodeGateProps) {
  const [code, setCode] = useState("");
  const { unlock } = useStaffAuth();
