    ...
    >
      <DialogContent className="sm:max-w-md p-0 gap-0 overflow-hidden">
        ...
        <div className="relative bg-black aspect-[4/3] w-full">
          ...
          {/* Aiming guide: corner reticle + sweeping beam */}
          <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center gap-2">
            <div className="relative h-28 w-4/5 overflow-hidden rounded-lg border-2 border-white/50">
            ...
            <p className="px-4 text-center text-[11px] leading-tight text-white drop-shadow">
              Keep the phone upright and pull the band flat — it reads at any angle.
            </p>
          </div>
