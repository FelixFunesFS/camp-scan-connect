-- Update activate_group_by_phone to only activate attendees with RFID tags
...
BEGIN
    ...
    -- ONLY update attendees.activated_at for attendees who have RFID tags
    UPDATE attendees a3
    SET activated_at = CASE 
        WHEN activated_at IS NULL THEN NOW() 
        ELSE activated_at 
...
-- Update activate_entire_order_by_phone to only activate attendees with RFID tags
...
-- Add function to activate remaining RFIDs by phone
