-- Fix transaction termination error in safe_cleanup_duplicates function
-- Remove explicit transaction control to prevent conflicts with Supabase RPC context
...
BEGIN
    ...
    -- Process each group of duplicates (removed BEGIN block)
