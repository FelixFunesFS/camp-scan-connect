-- Fix RFID consolidation in safe_cleanup_duplicates to prevent unique constraint violations
-- Implement smart RFID selection and proper deactivation of excess RFIDs
    ...
    LOOP
        ...
        LOOP
            ...
            SET status = 'unissued', 
                ...
                activated_at = NULL,
                deactivated_at = NOW(),
                reason = 'duplicate_cleanup_deactivation'
