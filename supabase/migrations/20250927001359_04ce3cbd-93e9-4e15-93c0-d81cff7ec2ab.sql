-- Fix the bulk_activate_assigned_rfids function to allow write operations
CREATE OR REPLACE FUNCTION public.bulk_activate_assigned_rfids()
 RETURNS TABLE(activation_successful boolean, total_activated integer, veterans_thanked integer, activated_attendees jsonb[], activation_details jsonb)
 LANGUAGE plpgsql
 SECURITY DEFINER
